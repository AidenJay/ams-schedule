                ...
                <div class="col-xs-2">
                    <div class="input-group">
                        ...
                        <select class="form-control" id="jobGroup"
                            ...
                            <#if Request["XXL_JOB_LOGIN_IDENTITY"]?? && Request["XXL_JOB_LOGIN_IDENTITY"].role == 1>
                        ...
                        <div class="box-body">
                            <table id="joblog_list" class="table table-bordered table-striped display" width="100%">
                                ...
                                <tr>
                                    ...
                                    <#if cookieMap?exists && cookieMap["XXL_JOB_LOGIN_IDENTITY"]?exists>
                                        <th name="handleMsg" id="isHide">${I18n.system_opt}</th>
                                    </#if>
                                </tr>
                                </thead>
                                <tbody></tbody>
