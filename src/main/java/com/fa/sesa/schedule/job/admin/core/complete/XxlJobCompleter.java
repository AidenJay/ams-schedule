package com.fa.sesa.schedule.job.admin.core.complete;
...
import com.fa.sesa.schedule.job.core.context.XxlJobContext;
                ...
                for (int i = 0; i < childJobIds.length; i++) {
                    ...
                    if (childJobId > 0) {
                        ...
                        triggerChildMsg += MessageFormat.format(I18nUtil.getString("jobconf_callback_child_msg1"),
                                                                ...
                                                                (triggerChildResult.getCode() ==
                                                                        ReturnT.SUCCESS_CODE ? I18nUtil.getString(
                                                                        "system_success") : I18nUtil.getString(
                                                                        "system_fail")), triggerChildResult.getMsg());
                    } else {
