    ...
    public void start() {
        monitorThread = new Thread(new Runnable() {
            ...
            public void run() {
                            ...
                            for (long failLogId : failLogIds) {
                                ...
                                if (log.getExecutorFailRetryCount() > 0) {
                                    JobTriggerPoolHelper.trigger(log.getJobId(), TriggerTypeEnum.RETRY,
                                                                 ...
                                                                 log.getExecutorShardingParam(), log.getExecutorParam(),
                                                                 null);
                ...
                logger.info(">>>>>>>>>>> schedule-job, job fail monitor thread stop");

            }
        });
        monitorThread.setDaemon(true);
        monitorThread.setName("schedule-job, admin JobFailMonitorHelper");
        monitorThread.start();
    }
