package com.fa.sesa.schedule.job.admin.core.trigger;
...
import com.fa.sesa.schedule.job.admin.core.scheduler.XxlJobScheduler;
import com.fa.sesa.schedule.job.admin.core.util.I18nUtil;
import com.fa.sesa.schedule.job.core.biz.ExecutorBiz;
...
import com.fa.sesa.schedule.job.core.util.ThrowableUtil;
...
public class XxlJobTrigger {
    ...
    private static void processTrigger(XxlJobGroup group, XxlJobInfo jobInfo, int finalFailRetryCount,
        ...
        String shardingParam = (ExecutorRouteStrategyEnum.SHARDING_BROADCAST ==
                executorRouteStrategyEnum) ? String.valueOf(index).concat("/").concat(String.valueOf(total)) : null;
        ...
        logger.debug(">>>>>>>>>>> schedule-job trigger start, jobId:{}", jobLog.getId());
        ...
        triggerMsgSb.append("<br>").append(I18nUtil.getString("jobconf_trigger_exe_regtype")).append("：")
                    .append((group.getAddressType() == 0) ? I18nUtil.getString(
        ...
        logger.debug(">>>>>>>>>>> schedule-job trigger end, jobId:{}", jobLog.getId());
    }
    ...
    public static ReturnT<String> runExecutor(TriggerParam triggerParam, String address) {
        ...
        try {
            ...
            logger.error(">>>>>>>>>>> schedule-job trigger error, please check if the executor[{}] is running.",
                         address, e);
