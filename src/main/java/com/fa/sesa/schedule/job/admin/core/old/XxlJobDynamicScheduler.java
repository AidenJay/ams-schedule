...
//        initRpcProvider();
//
//        logger.info(">>>>>>>>> init schedule-job admin success.");
//    }
//
//
...
//
//        // add services
//        xxlRpcProviderFactory.addService(AdminBiz.class.getName(), null, XxlJobAdminConfig.getAdminConfig()
//        .getAdminBiz());
//
//        // servlet handler
...
//    }
//    public static void invokeAdminService(HttpServletRequest request, HttpServletResponse response) throws
...
//
//    // ---------------------- executor-client ----------------------
//    private static ConcurrentHashMap<String, ExecutorBiz> executorBizRepository = new ConcurrentHashMap<String,
//    ExecutorBiz>();
...
//        CronTrigger cronTrigger = TriggerBuilder.newTrigger().withIdentity(triggerKey).withSchedule
...
//
//        logger.info(">>>>>>>>>>> addJob success(quartz), jobDetail:{}, cronTrigger:{}, date:{}", jobDetail,
//        cronTrigger, date);
//        return true;
//    }
//
