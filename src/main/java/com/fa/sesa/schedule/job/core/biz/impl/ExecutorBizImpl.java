package com.fa.sesa.schedule.job.core.biz.impl;

import com.fa.sesa.schedule.job.core.biz.ExecutorBiz;
import com.fa.sesa.schedule.job.core.biz.model.*;
...
import com.fa.sesa.schedule.job.core.handler.impl.GlueJobHandler;
import com.fa.sesa.schedule.job.core.handler.impl.ScriptJobHandler;
...
public class ExecutorBizImpl implements ExecutorBiz {
    ...
    public ReturnT<String> run(TriggerParam triggerParam) {
        ...
        if (GlueTypeEnum.BEAN == glueTypeEnum) {
            ...
            if (jobHandler == null) {
                try {
                    IJobHandler originJobHandler = GlueFactory.getInstance().loadNewInstance(
