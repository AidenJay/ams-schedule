...
import com.fa.sesa.schedule.job.admin.core.expression.CronExpression;
import com.fa.sesa.schedule.job.admin.core.model.XxlJobGroup;
import com.fa.sesa.schedule.job.admin.core.model.XxlJobInfo;
import com.fa.sesa.schedule.job.admin.core.model.XxlJobLogReport;
import com.fa.sesa.schedule.job.admin.core.route.ExecutorRouteStrategyEnum;
import com.fa.sesa.schedule.job.admin.core.scheduler.MisfireStrategyEnum;
import com.fa.sesa.schedule.job.admin.core.scheduler.ScheduleTypeEnum;
import com.fa.sesa.schedule.job.admin.core.thread.JobScheduleHelper;
import com.fa.sesa.schedule.job.admin.core.util.I18nUtil;
import com.fa.sesa.schedule.job.admin.dao.*;
import com.fa.sesa.schedule.job.admin.service.XxlJobService;
import com.fa.sesa.schedule.job.core.biz.model.ReturnT;
import com.fa.sesa.schedule.job.core.enums.ExecutorBlockStrategyEnum;
import com.fa.sesa.schedule.job.core.glue.GlueTypeEnum;
import com.fa.sesa.schedule.job.core.util.DateUtil;
...
public class XxlJobServiceImpl implements XxlJobService {
    ...
    public ReturnT<String> add(XxlJobInfo jobInfo) {
        ...
        if (jobInfo.getJobDesc() == null || jobInfo.getJobDesc().trim().length() == 0) {
            return new ReturnT<String>(ReturnT.FAIL_CODE, (I18nUtil.getString("system_please_input") +
        ...
        if (scheduleTypeEnum == ScheduleTypeEnum.CRON) {
            ...
            //                if (fixSecond < 1) {
            //                    return new ReturnT<String>(ReturnT.FAIL_CODE,
            //                                               (I18nUtil.getString("schedule_type") + I18nUtil.getString(
            //                                                   "system_unvalid")));
            //                }
            //            } catch (Exception e) {
            //                return new ReturnT<String>(ReturnT.FAIL_CODE, (I18nUtil.getString("schedule_type") +
        ...
        if (GlueTypeEnum.match(jobInfo.getGlueType()) == null) {
            return new ReturnT<String>(ReturnT.FAIL_CODE, (I18nUtil.getString("jobinfo_field_gluetype") +
        ...
        if (ExecutorRouteStrategyEnum.match(jobInfo.getExecutorRouteStrategy(), null) == null) {
            return new ReturnT<String>(ReturnT.FAIL_CODE, (I18nUtil.getString("jobinfo_field_executorRouteStrategy") +
                    I18nUtil.getString("system_unvalid")));
        }
        ...
        if (ExecutorBlockStrategyEnum.match(jobInfo.getExecutorBlockStrategy(), null) == null) {
            return new ReturnT<String>(ReturnT.FAIL_CODE, (I18nUtil.getString("jobinfo_field_executorBlockStrategy") +
                    I18nUtil.getString("system_unvalid")));
        }
            ...
            for (String childJobIdItem : childJobIds) {
                if (childJobIdItem != null && childJobIdItem.trim().length() > 0 && isNumeric(childJobIdItem)) {
                    ...
                    if (childJobInfo == null) {
                        return new ReturnT<String>(ReturnT.FAIL_CODE, MessageFormat.format(
                                (I18nUtil.getString("jobinfo_field_childJobId") + "({0})" +
    ...
    public ReturnT<String> update(XxlJobInfo jobInfo) {
        ...
        if (jobGroup == null) {
            return new ReturnT<String>(ReturnT.FAIL_CODE, (I18nUtil.getString("jobinfo_field_jobgroup") +
                    I18nUtil.getString("system_unvalid")));
        }
        ...
        if (exists_jobInfo == null) {
            return new ReturnT<String>(ReturnT.FAIL_CODE, (I18nUtil.getString("jobinfo_field_id") +
        ...
        if (exists_jobInfo.getTriggerStatus() == 1 && !scheduleDataNotChanged) {
            try {
                Date nextValidTime = JobScheduleHelper.generateNextValidTime(jobInfo, new Date(
                        System.currentTimeMillis() + JobScheduleHelper.PRE_READ_MS));
    ...
    public ReturnT<String> start(int id) {
        ...
        try {
            Date nextValidTime = JobScheduleHelper.generateNextValidTime(xxlJobInfo, new Date(
                    System.currentTimeMillis() + JobScheduleHelper.PRE_READ_MS));
            if (nextValidTime == null) {
                return new ReturnT<String>(ReturnT.FAIL_CODE, (I18nUtil.getString("schedule_type") +
                        I18nUtil.getString("system_unvalid")));
    ...
    public Map<String, Object> dashboardInfo() {
        ...
        if (xxlJobLogReport != null) {
            jobLogCount =
                    xxlJobLogReport.getRunningCount() + xxlJobLogReport.getSucCount() + xxlJobLogReport.getFailCount();
    ...
    @Override
    public ReturnT<String> addBatchJob(List<XxlJobInfo> jobInfos) {
    ...
    @Override
    public ReturnT<String> batchRemove(Long jobBatchId) {
        batchStop(jobBatchId);
        xxlJobInfoDao.batchDelete(jobBatchId);
        return ReturnT.SUCCESS;
    }

    @Override
    public ReturnT<String> batchStop(Long jobBatchId) {
        List<XxlJobInfo> jobInfos = xxlJobInfoDao.getJobsByBatchId(jobBatchId);
        for (XxlJobInfo jobInfo : jobInfos) {
    ...
    public ReturnT<String> batchUpdateNextTimeByTaskId(List<XxlJobInfo> xxlJobInfos) {
        for (XxlJobInfo xxlJobInfo : xxlJobInfos) {
            updateNextTimeByTaskId(xxlJobInfo);
        }
        return ReturnT.SUCCESS;
    }
    ...
    public ReturnT<String> removeByBatchIdAndTaskId(Long jobBatchId, String taskId) {
        xxlJobInfoDao.deleteByBatchIdAndTaskId(jobBatchId, taskId);
        return ReturnT.SUCCESS;
    }
