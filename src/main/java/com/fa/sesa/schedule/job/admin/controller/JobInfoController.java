...
import com.fa.sesa.schedule.job.admin.core.exception.XxlJobException;
...
import com.fa.sesa.schedule.job.admin.core.thread.JobTriggerPoolHelper;
...
import com.fa.sesa.schedule.job.admin.service.LoginService;
...
public class JobInfoController {
    ...
    public ReturnT<List<String>> nextTriggerTime(String scheduleType, String scheduleConf) {
        ...
        try {
            ...
            return new ReturnT<List<String>>(ReturnT.FAIL_CODE, (I18nUtil.getString("schedule_type") +
                    I18nUtil.getString("system_unvalid")) + e.getMessage());
        }
