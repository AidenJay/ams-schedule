package com.fa.sesa.schedule.job.admin.core.alarm.impl;

import com.fa.sesa.schedule.job.admin.core.alarm.JobAlarm;
    ...
    public boolean doAlarm(XxlJobInfo info, XxlJobLog jobLog) {
        ...
        if (info != null && info.getAlarmEmail() != null && info.getAlarmEmail().trim().length() > 0) {
            ...
            String content = MessageFormat.format(loadEmailJobAlarmTemplate(),
                                                  group != null ? group.getTitle() : "null", info.getId(),
                                                  info.getJobDesc(), alarmContent);
            ...
            for (String email : emailSet) {
                ...
                try {
                    ...
                    logger.error(">>>>>>>>>>> schedule-job, job fail alarm email send error, JobLogId:{}",
                                 jobLog.getId(), e);
